...
define('USERNAME', "alertes.serveur.surveillance@gmail.com");
 
// Define your 16 digit Gmail app-password.
define('PASSWORD', "hcmg vokk vrki dekn");
 
// Define the email address from which the email is sent.
define('SEND_FROM', "info@alertes.serveur.surveillance.com");
 
// Define the name of the website from which the email is sent. 
define('SEND_FROM_NAME', "alertes.serveur.surveillance");
 
// Define the reply-to address.
define('REPLY_TO', "info@alertes.serveur.surveillance.com");
 
// Define the reply-to name.
define('REPLY_TO_NAME', "alertes.serveur.surveillance");